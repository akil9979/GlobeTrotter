...
import { addTripActivity, deleteTripActivity, listTripActivities, reorderTripActivities, updateTripActivity } from "../controllers/tripActivityController.js";
...
tripActivityRouter.get("/", asyncHandler(listTripActivities));
...
tripActivityRouter.put("/:tripActivityId", validate(requireParamUuid("tripActivityId")), validate(validateTripActivityUpdate), asyncHandler(updateTripActivity));
