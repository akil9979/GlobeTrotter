...
export const listTripActivities: RequestHandler = async (req, res) => { res.json({ scheduledActivities: await tripActivityService.list(req.userId!, routeParam(req, "tripId")) }); };
